      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
            ...
            <div className="flex items-center space-x-4">
              <div className="relative">
                ...
                <img 
                  ...
                  className="relative w-14 h-14 lg:w-16 lg:h-16 object-contain rounded-2xl bg-gradient-to-r from-blue-50 to-purple-50 p-2"
                  loading="lazy"
                />
              </div>
              <div>
                ...
                <p className="text-blue-400 font-semibold text-base lg:text-lg">
                  Senior Software Engineer
                </p>
              </div>
            </div>
            
            <p className="text-gray-300 max-w-lg leading-relaxed text-base lg:text-lg">
              ...
              {quickLinks.map((link, index) => (
                <li key={index}>
                  <button
                    ...
                    className="group flex items-center space-x-3 text-gray-300 hover:text-white transition-all duration-300 text-left"
                  >
              ...
              <li className="group">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400 break-all">nitjaitwar@gmail.com</p>
                  </div>
                </a>
              </li>
              ...
              <li className="group">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">+91 7440800704</p>
                  </div>
                </a>
              </li>
            </ul>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center space-y-6 lg:space-y-0">
          ...
          <div className="flex items-center space-x-6">
            ...
            <button
              onClick={scrollToTop}
              className="group relative overflow-hidden w-12 h-12 lg:w-14 lg:h-14 bg-gradient-to-r from-gray-700 to-gray-600 rounded-2xl flex items-center justify-center hover:from-blue-600 hover:to-purple-600 transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 shadow-lg hover:shadow-2xl"
              aria-label="Scroll to top"
            >
              <svg className="w-6 h-6 text-gray-300 group-hover:text-white transition-all duration-300 transform group-hover:scale-110 group-hover:-translate-y-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Floating Elements */}
        <div className="absolute top-10 right-10 w-32 h-32 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full opacity-10 blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 left-20 w-24 h-24 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full opacity-10 blur-2xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
    </footer>
  );
};
