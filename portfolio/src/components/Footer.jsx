        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2 space-y-4">
            <div className="flex items-center space-x-3">
              ...
              />
              <div>
                <h3 className="text-xl font-bold">Nitesh Jaitwar</h3>
                <p className="text-gray-400">Software Engineer</p>
              </div>
            </div>
            <p className="text-gray-400 max-w-md leading-relaxed">
              Passionate Java Developer with 4+ years of experience in building robust and scalable applications. 
              Always excited to take on new challenges and contribute to innovative projects.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span className="text-sm">nitjaitwar@gmail.com</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"></path>
                </svg>
                <span className="text-sm">+91 7440800704</span>
              </li>
            </ul>
          </div>
        </div>
