      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative hidden lg:block">
          ...
          {experiences.map((experience, index) => (
            <div key={index} className={`relative flex items-center mb-20 last:mb-0 ${index % 2 === 0 ? 'flex-row-reverse' : ''}`}>
              ...
              <div className={`w-5/12 ${index % 2 === 0 ? 'pr-16' : 'pl-16'}`}>
                <div className="group bg-white p-8 lg:p-10 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border-2 border-gray-100 hover:border-blue-200">
                  {/* Header */}
                  <div className="mb-6">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-blue-600 font-bold text-lg">{experience.company}</span>
                        <span className="text-sm text-gray-500 bg-gray-100 px-3 py-1 rounded-full">
                          {experience.companyType}
                        </span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-gray-600 text-sm font-medium">📍 {experience.location}</span>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {experience.technologies.map((tech, techIndex) => (
                      <span
                        key={techIndex}
                        className="px-3 py-1.5 bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 rounded-full text-sm font-medium hover:from-blue-100 hover:to-purple-100 hover:text-blue-800 transition-all duration-300 transform hover:scale-105"
                      >
                        {tech}
                      </span>
                    ))}
          ...
          {experiences.map((experience, index) => (
            <div key={index} className="relative flex items-start mb-12 last:mb-0">
              ...
              <div className="ml-16 flex-1">
                <div className="bg-white p-6 lg:p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-blue-200">
                  <div className="mb-4">
                    <h3 className="text-lg lg:text-xl font-bold text-gray-900 mb-2">{experience.title}</h3>
                    <div className="space-y-2">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <span className="text-blue-600 font-bold">{experience.company}</span>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <span className="inline-block px-3 py-1 bg-gradient-to-r from-blue-100 to-purple-100 text-blue-800 rounded-full text-sm font-semibold self-start sm:self-auto">
                          {experience.period}
                        </span>
                      </div>
                    </div>
        ...
        <div className="mt-20 lg:mt-24">
          <div className="bg-gradient-to-r from-blue-50 via-white to-purple-50 rounded-2xl lg:rounded-3xl p-8 lg:p-12 border-2 border-gray-100">
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-8 lg:mb-12 text-center">
              Career{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">
                Highlights
              </span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 lg:gap-12">
              <div className="text-center group">
                <div className="relative mb-4">
                  <div className="text-4xl sm:text-5xl lg:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-700 group-hover:scale-110 transition-transform duration-300">
                    4+
                  </div>
              ...
              <div className="text-center group">
                <div className="relative mb-4">
                  <div className="text-4xl sm:text-5xl lg:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-purple-700 group-hover:scale-110 transition-transform duration-300">
                    50+
                  </div>
              ...
              <div className="text-center group">
                <div className="relative mb-4">
                  <div className="text-4xl sm:text-5xl lg:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-blue-600 group-hover:scale-110 transition-transform duration-300">
                    10+
                  </div>
